...
# and their difference
  ...
  plot(state_quant[,3]-state_quant[,2])
...
# combine balticgrid with calculated state at 25th and 75th quantile
  balticgrid@data <- cbind(balticgrid@data, state_quant[match(balticgrid@data$squares, state_quant$squares),c(2:3)])
  names(balticgrid@data)[24] <- "Q25_state"
  names(balticgrid@data)[25] <- "Q75_state"
